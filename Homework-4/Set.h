...
public:
    ...
    bool get(int i, ItemType &value) const
    {
        ...
        // descending order, the value at position i will be less than
    ...
    ~Set()
    {
        // Delete all Nodes from last non-dummy down to but not including
        // the dummy
...
private:
    ...
    Node *findFirstAtMost(const ItemType &value) const
    {
...
template <typename ItemType>
void inOnlyOne(const Set<ItemType> &s1, const Set<ItemType> &s2, Set<ItemType> &result)
{
